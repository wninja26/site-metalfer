      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center bg-black border border-gray-800 rounded-xl p-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 hover:scale-105"
          >
